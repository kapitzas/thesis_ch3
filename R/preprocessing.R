...
raw_path <-  file.path("Volumes", "external", "OneDrive - The University of Melbourne", "PhD - Large Files", "PhD - Raw Data")
...
mask <- raster(file.path("data", "data_ama", "temp", "ts1992_l01_ama.tif"))
